...
namespace Pyz\Yves\EchidnaPayment\Form\DataProvider;
...
class EchidnaPaymentCreditCardFormDataProvider implements StepEngineFormDataProviderInterface
{
    /**
    ...
    public function getData(AbstractTransfer $quoteTransfer): QuoteTransfer
    {
        if ($quoteTransfer->getPayment() === null) {
            ...
            $paymentTransfer->setEchidnaPayment(new EchidnaPaymentTransfer());
            $paymentTransfer->setEchidnaPaymentCreditCard(new EchidnaPaymentTransfer());
